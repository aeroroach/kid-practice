...
3. **Data Isolation**: The quiz questions must be stored in a clean, clearly commented JavaScript array named `QUIZ_DATA` at the top of the `<script>` tag. This allows easy topical rewrites without touching the UI rendering logic.
